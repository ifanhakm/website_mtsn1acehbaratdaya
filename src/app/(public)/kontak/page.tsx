...
export default function KontakPage() {
  ...
  const faqs: FAQItem[] = [
    {
      ...
      answer: "Anda dapat mengunduh Blangko Surat Keterangan Aktif Siswa terlebih dahulu di menu 'Layanan > Pusat Unduh'. Setelah diisi, serahkan berkas tersebut ke bagian Tata Usaha (TU) madrasah pada jam kerja untuk ditandatangani dan dicap resmi oleh Kepala Madrasah.",
    },
    {
      question: "Kapan jam kerja operasional pelayanan Tata Usaha?",
      answer: "Pelayanan administrasi Tata Usaha MTsN 1 Aceh Barat Daya buka setiap hari Senin s.d. Jumat pukul 08:00 - 16:00 WIB. Kantor libur pada hari Sabtu, Minggu, dan hari libur nasional.",
    },
    {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Simulasi pengiriman data lokal (MVP)
    setTimeout(() => {
  ...
  return (
    <div className="min-h-screen bg-gray-50/50">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-1">
              ...
              <div className="bg-white rounded-2xl border border-gray-100 p-5 shadow-xs hover:shadow-md transition-all duration-300 flex gap-4">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <a 
                    href="https://maps.app.goo.gl/rLrPVo1txWVGKtNV9" 
                    target="_blank" 
                    rel="noreferrer" 
            ...
            <div className="bg-white rounded-3xl border border-gray-100 p-6 sm:p-10 shadow-xl relative overflow-hidden">
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400 font-medium">Pesan akan langsung masuk ke dashboard humas kami.</p>
                </div>
              </div>
              ...
              {isSuccess ? (
                ...
                <div className="py-12 flex flex-col items-center text-center gap-4 animate-fade-in">
                  ...
                  <button
                    ...
                    className="mt-4 inline-flex items-center justify-center rounded-full bg-brand-green text-white px-6 py-2.5 text-sm font-extrabold hover:bg-emerald-950 hover:shadow-lg transition-all duration-300"
                  >
                    Kirim Pesan Lainnya
                  </button>
                </div>
                  ...
                  <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <input
                        ...
                        name="email"
                        required
                        placeholder="Contoh: namasaya@gmail.com"
                        value={form.email}
                        onChange={handleInputChange}
                        className="w-full rounded-xl border border-gray-200 bg-gray-50/50 px-4 py-3 text-sm font-semibold text-gray-800 outline-none focus:border-brand-green focus:bg-white focus:ring-4 focus:ring-brand-green/10 transition-all duration-300"
                      />
      ...
      {/* 4. MAPS EMPOWERMENT SECTION (Saran Penempatan Google Maps) */}
      <div className="bg-gray-50/50 py-16 border-t border-gray-100">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          {/* Iframe Maps Wrapper */}
          <div className="w-full h-[450px] rounded-3xl overflow-hidden shadow-lg border border-gray-200/60 relative group">
            <iframe 
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1990.6882037560472!2d96.82232375064888!3d3.7278472379742618!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x303961efedbcebd1%3A0x82c3df9a3c136a20!2sMTsN%20Unggul%20Susoh!5e0!3m2!1sid!2sid!4v1787599368447!5m2!1sid!2sid" 
              width="100%" 
              height="100%" 
              style={{ border: 0 }} 
