...
import { Award, BookOpen, Calendar, MapPin, Users, ChevronRight, Milestone } from "lucide-react";
  ...
  const timelineData = [
    {
      ...
      description:
        "Berdiri pertama kali sebagai Madrasah Tsanawiyah Agama Islam Swasta (M.Ts.A.I.S) Kabupaten Aceh Selatan. Di tahun yang sama, berdasarkan Surat Keputusan Menteri Agama No. 84 Tahun 1969, madrasah ini resmi dinegerikan menjadi Madrasah Tsanawiyah Agama Islam Negeri (M.Ts.A.I.N) yang berlokasi di Desa Pantai Perak, Kecamatan Susoh.",
    ...
    },
    {
      ...
      description:
        "Pada tahun pelajaran 1998/1999, madrasah meraih prestasi luar biasa dengan menyabet Juara II Lomba Prestasi Madrasah Tingkat Nasional. Penghargaan bergengsi ini disahkan melalui Keputusan Direktorat Jenderal Pembinaan Kelembagaan Agama Islam Nomor: E. IV/PP.00/KEP/01/99 tertanggal 28 Desember 1998.",
    ...
    },
    {
      ...
      description:
        "Sebagai buah dari jerih payah dan berbagai prestasi emas yang ditorehkan, pada 31 Juli 2001, Kepala Kantor Wilayah Departemen Agama Provinsi Daerah Istimewa Aceh secara resmi meresmikan MTsN Susoh menjadi 'MTsN Unggul Susoh'. Nama ini melekat kuat di hati masyarakat sebagai simbol pendidikan berkualitas tinggi.",
    ...
    },
    {
      ...
      description:
        "Seiring pemekaran kabupaten dan regulasi pemerintah, nomenklatur madrasah disesuaikan menjadi MTsN 1 Aceh Barat Daya. Saat ini, madrasah terus berbenah dan berinovasi di bidang keagamaan maupun mutu pembelajaran umum, menjadikannya salah satu 'Madrasah Inovasi' percontohan resmi di tingkat Provinsi Aceh.",
    ...
    <div className="min-h-screen bg-gray-50/50">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-base sm:text-lg text-gray-200 leading-relaxed">
              Menelusuri jejak rekam sejarah dari sebuah madrasah swasta sederhana pada tahun 1969 
              hingga bertransformasi menjadi Madrasah Inovasi Unggulan di Provinsi Aceh saat ini.
            </p>
          </div>
        </div>
      </div>

      {/* 2. SINOPSIS & PENGANTAR UTAMA */}
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 items-center">
          ...
          <div className="lg:col-span-5 relative group">
            ...
            <div className="relative overflow-hidden rounded-xl bg-white border border-gray-100 p-3 shadow-xl">
              <div className="relative h-72 sm:h-96 w-full rounded-lg bg-gray-100 flex items-center justify-center overflow-hidden">
                {/* Fallback visual jika gambar belum diunggah */}
          ...
          {/* Sisi Kanan: Teks Pengantar Terstruktur */}
          <div className="lg:col-span-7 flex flex-col gap-6">
            ...
            <h2 className="text-2xl font-extrabold text-brand-green sm:text-3xl tracking-tight">
              Pilar Pendidikan Islami Terbua dan Bersejarah
            </h2>
            <div className="text-base text-gray-600 leading-relaxed space-y-4 font-medium">
              <p>
                Madrasah Tsanawiyah Negeri 1 Aceh Barat Daya merupakan salah satu lembaga pendidikan tingkat 
                Tsanawiyah tertua dan paling bersejarah di Kabupaten Aceh Barat Daya. Berdiri kokoh di Pantai Perak, 
                Susoh, madrasah ini telah melahirkan ratusan bahkan ribuan tokoh terkemuka, pemikir, serta praktisi 
                hebat yang berkontribusi aktif bagi pembangunan daerah dan nasional.
              </p>
              <p>
                Kombinasi budaya masyarakat sekitar yang kental dengan nuansa Islami, kesadaran tinggi akan pentingnya 
                pendidikan agama, serta kepemimpinan yang progresif telah mendorong madrasah ini terus bertumbuh 
                melewati berbagai dekade perubahan regulasi dan nomenklatur kenegaraan.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* 3. SECTION: LINI MASA (VERTICAL TIMELINE VISUAL) */}
      <div className="bg-white border-y border-gray-100 py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative mx-auto max-w-4xl">
            {/* Garis Tengah Timeline (Desktop: Tengah, Mobile: Samping Kiri) */}
              ...
              {timelineData.map((item, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="absolute left-0 top-1.5 flex h-8.5 w-8.5 items-center justify-center rounded-full bg-brand-green border-4 border-white shadow-md z-10 md:left-1/2 md:-ml-4.5">
                      {item.icon}
                    </div>

                    {/* Desktop Layout Alternating Card */}
                    {/* Bagian Kiri (Untuk indeks genap) */}
                    <div
                    ...
                    >
                      {isEven && (
                        <div className="bg-gray-50 rounded-2xl border border-gray-100 p-6 shadow-sm hover:shadow-md hover:border-brand-green/20 transition-all duration-300">
                          ...
                          <div className="flex items-baseline justify-start md:justify-end gap-2 mb-2">
                    ...
                    {/* Bagian Kanan (Untuk indeks ganjil) */}
                    <div className={`w-full pl-12 md:pl-0 md:w-[45%] ${!isEven ? "md:order-2" : "md:order-1 md:opacity-0 md:h-0 md:overflow-hidden md:pointer-events-none"}`}>
                      {!isEven && (
                        <div className="bg-gray-50 rounded-2xl border border-gray-100 p-6 shadow-sm hover:shadow-md hover:border-brand-green/20 transition-all duration-300">
                          <span className="inline-block text-xs font-extrabold uppercase tracking-wider text-brand-gold bg-brand-gold/10 px-3 py-1 rounded-full mb-3">
                            {item.badge}
                    ...
                    {/* Mobile fallback (Memastikan kartu ganjil tetap tampil di mobile) */}
                    <div className="w-full pl-12 md:hidden">
                      {!isEven && (
                        <div className="bg-gray-50 rounded-2xl border border-gray-100 p-6 shadow-sm hover:shadow-md transition-all duration-300 mt-2">
                          <span className="inline-block text-xs font-extrabold uppercase tracking-wider text-brand-gold bg-brand-gold/10 px-3 py-1 rounded-full mb-3">
                            {item.badge}
                          </span>
                          <div className="flex items-baseline justify-start gap-2 mb-2">
        ...
        <div className="rounded-3xl bg-gradient-to-br from-brand-green to-emerald-950 p-10 sm:p-16 text-white relative overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10 max-w-3xl mx-auto flex flex-col items-center gap-6">
            ...
            <p className="text-base text-gray-200 leading-relaxed font-medium">
              "Jerih payah, kerja keras, dan prestasi legendaris masa lalu adalah fondasi kokoh bagi kami. 
              Kini, MTsN 1 Aceh Barat Daya terus berbenah secara digital, berinovasi secara akademik, demi 
              mewujudkan visi melahirkan generasi islami, qur'ani, bermutu unggul, dan berwawasan lingkungan."
            </p>
